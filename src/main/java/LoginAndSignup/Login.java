...
public class Login extends javax.swing.JFrame {
    ...
    UserAndPass kiffy = new UserAndPass();
    /**
    ...
    private void initComponents() {
        ...
        curvedPanel1.setRoundBottomLeft(25);
        curvedPanel1.setRoundBottomRight(25);
        curvedPanel1.setRoundTopLeft(25);
        curvedPanel1.setRoundTopRight(25);

        jTextField1.setBackground(new java.awt.Color(10, 9, 9));
        jTextField1.setForeground(new java.awt.Color(255, 255, 255));
        jTextField1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 4, 0, new java.awt.Color(255, 255, 255)));

        jPasswordField1.setBackground(new java.awt.Color(10, 9, 9));
        jPasswordField1.setForeground(new java.awt.Color(255, 255, 255));
        jPasswordField1.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 4, 0, new java.awt.Color(255, 255, 255)));
        ...
        Nigga.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        Nigga.setForeground(new java.awt.Color(0, 0, 0));
        Nigga.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Nigga.setText("Login");
        Nigga.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Nigga.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                NiggaMouseClicked(evt);
            }
        });
        ...
        curvedPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(curvedPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(Nigga, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void NiggaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NiggaMouseClicked
        
        String studentnumber = jTextField1.getText();
        String studentpassword = String.valueOf(jPasswordField1.getPassword());
        String passDb = null;
        try{  Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
            ...
            String query = "SELECT * FROM LoginInfo WHERE StudentID= '"+studentnumber+"'";
            ...
            if(notFound == 1 && studentpassword.equals(passDb)){
                dispose();
    ...
    }//GEN-LAST:event_NiggaMouseClicked
    ...
    private javax.swing.JLabel Nigga;
